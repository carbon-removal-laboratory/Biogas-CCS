...
param tc_fs {VALID_PAIR};
param tc_co2 {VALID_SEQ};
param fs_dist {VALID_PAIR};
param seq_dist {VALID_SEQ};
...
param comp_fc_intercept = 95430;
param comp_vc_intercept = 7575;
param comp_fc_slope1 = 2.79;
param comp_vc_slope1 = 20.15;
param comp_fc_slope2 = 1.39;
param comp_vc_slope2 = 20.10;
param limit_comp_fc = 106896;
...
param cellulosic_waiver default 22.98;
...
param compression_work = 83.87; #kwh/tco2/yr
param electricity_emissions = 0.0002; #tco2/kwh
param transport_emissions = 161.8; #gco2/kwh
...
sum{(s,f) in VALID_PAIR, t in TYPE}  (life * (
		tc_fs[s,f] * q_feed[s,f,t]/25 +
		fs_ton[s,f] * q_feed[s,f,t] ) 
		)
	+
...
sum{(f,i) in VALID_SEQ}( life * (
		tc_co2[f,i] *q_co2trans[f,i]/co2truck_capacity +
		lcfs_price * transport_emissions * seq_dist[f,i] / 1000000 )# emissions from transport
	)
;
